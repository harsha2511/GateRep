...
import { Book, ArrowLeft, User, Lock } from 'lucide-react';
...
const StudentLogin = () => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    // Navigate directly to student dashboard without branch selection
    navigate('/dashboard/ece');
  };
      ...
      <div className="flex items-center justify-center py-12 px-4">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <p className="text-gray-600">Enter your credentials to access mock tests</p>
          </CardHeader>
          <CardContent>
